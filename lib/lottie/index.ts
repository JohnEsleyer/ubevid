import { getLottieValue } from "./interpolator.js"; import { bezierToPath, lottieColorToHex } from "./converter.js"; import { generatePolystarPath } from "./shapes.js"; import { measurePath } from "../engine.js"; import type { SceneNode, StyleConfig } from "../types.js"; import type { LottieJSON, LottieTrimPath, LottiePolystar, LottieLayer } from "./types.js";

function renderLayer(layer: LottieLayer, frame: number): SceneNode | null { if (frame < layer.st || frame >= layer.op) return null;
...
export function lottieToScene(lottie: LottieJSON, frame: number): SceneNode { const layers = lottie.layers; const rootChildren: SceneNode[] = []; const processedIndices = new Set();
